    ...
    <section class="flex items-center justify-center py-24">
        <div class="container w-[85%]  mx-auto px-6 text-center">
            ...
            <p class="mt-4 text-lg md:text-xl text-obito-text-secondary">
                Bergabung sebagai mitra dan nikmati akses spesial untuk pembelian skala besar. <br>Hemat lebih banyak, jual lebih untung, dan dukung petani kopi lokal!
            </p>
    
            <!-- CTA Button -->
            <div class="mt-8">
                <a href="{{ url('/mitra/register') }}" 
            ...
            <div class="grid md:grid-cols-3 gap-10 text-center">
                ...
                <div class="bg-[#F9F9F9] rounded-2xl p-8 shadow-md hover:shadow-lg transition">
                    <div class="mb-4 flex justify-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 14l-3-3m0 0l3-3m-3 3h12m-6-3v12" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold mb-2 text-font">Harga Grosir Khusus</h3>
                    <p class="text-obito-text-secondary">Nikmati harga spesial untuk pembelian dalam jumlah besar sebagai mitra resmi kami.</p>
                </div>
                ...
                <div class="bg-[#F9F9F9] rounded-2xl p-8 shadow-md hover:shadow-lg transition">
                    <div class="mb-4 flex justify-center">
                        <!-- Icon (support) -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 13v6a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-6M12 3v10m0 0l-3-3m3 3l3-3" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold mb-2 text-font">Dukungan Mitra</h3>
                    <p class="text-obito-text-secondary">Tim kami siap membantu kebutuhan mitra, mulai dari pengiriman hingga stok produk.</p>
                </div>
                ...
                <div class="bg-[#F9F9F9] rounded-2xl p-8 shadow-md hover:shadow-lg transition">
                    <div class="mb-4 flex justify-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 16h8m-8 0a4 4 0 0 1-4-4V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v6a4 4 0 0 1-4 4m-8 0v4m8-4v4" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold mb-2 text-font">Dukung Kopi Lokal</h3>
                    <p class="text-obito-text-secondary">Setiap pembelian Anda turut memberdayakan petani kopi lokal di Indonesia.</p>
                </div>
            </div>
        </div>
    </section>
          ...
          <div class="relative border-l-2 border-primary ml-6">
            ...
            <div class="mb-12 ml-10 flex items-start">
              <div class="flex flex-col items-center mr-6">
                <div class="bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">1</div>
              ...
              <div>
                ...
                <p class="mt-2 text-gray-600 max-w-md">
                  Isi formulir pendaftaran kemitraan secara lengkap melalui halaman Join Us untuk membuat akun mitra.
                </p>
              </div>
            </div>
            ...
            <div class="mb-12 ml-10 flex items-start">
              <div class="flex flex-col items-center mr-6">
                <div class="bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">2</div>
                <div class="w-px h-full bg-primary"></div>
              </div>
              <div>
            ...
            <div class="mb-12 ml-10 flex items-start">
              <div class="flex flex-col items-center mr-6">
                <div class="bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">3</div>
                <div class="w-px h-full bg-primary"></div>
              </div>
              <div>
            ...
            <div class="mb-12 ml-10 flex items-start">
              <div class="flex flex-col items-center mr-6">
                <div class="bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">4</div>
                <div class="w-px h-full bg-primary"></div>
              </div>
              <div>
                <h3 class="text-xl font-semibold text-primary">Cek Notifikasi</h3>
                <p class="mt-2 text-gray-600 max-w-md">
                  Periksa notifikasi secara berkala di dashboard untuk melihat status pengajuan kemitraan Anda.
                </p>
              </div>
            </div>
            ...
            <div class="ml-10 flex items-start">
              <div class="flex flex-col items-center mr-6">
                <div class="bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center font-semibold">5</div>
              </div>
              <div>
