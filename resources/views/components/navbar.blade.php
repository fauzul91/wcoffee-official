            ...
            @auth
                <div class="flex items-center gap-3">
                    ...
                    @elseif(auth()->user()->hasRole('mitra'))
                        <a href="{{ url('/mitra') }}" class="rounded-full py-3 px-5 bg-obito-green text-white font-semibold hover:drop-shadow-2xl transition-all duration-300">
                            Dashboard
                        </a>
                    @else
                        <div x-data="{ open: false }" class="relative flex items-center gap-2">
                            ...
                            <span class="font-semibold text-[1rem] mr-2">{{ auth()->user()->name }}</span> 
                            ...
                            >
                                <ul class="py-2">
                                    <li>
                                        <a href="{{ url('/customer/profile') }}" class="block px-4 py-2 hover:bg-gray-100">Profile</a>
                                    </li>
                                    <li>
